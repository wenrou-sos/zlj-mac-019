...
#define CONFIGURE_ARGS " '--prefix=/workspace/pgenv' '--with-libraries=/workspace/pgenv/lib' '--with-includes=/workspace/pgenv/include' '--enable-thread-safety' '--with-gssapi' '--with-icu' '--with-ldap' '--with-libxml' '--with-libxslt' '--with-lz4' '--with-ssl=openssl' '--with-uuid=e2fs' '--with-zstd' '--with-system-tzdata=/workspace/pgenv/share/zoneinfo' '--with-liburing' 'PG_SYSROOT=undefined' 'build_alias=aarch64-conda-linux-gnu' 'host_alias=aarch64-conda-linux-gnu' 'CC=aarch64-conda-linux-gnu-cc' 'CFLAGS=-ftree-vectorize -fPIC -fstack-protector-strong -fno-plt -O3 -pipe -fno-merge-constants -isystem /workspace/pgenv/include -fdebug-prefix-map=/home/conda/feedstock_root/build_artifacts/postgresql-split_1788538632535/work=/usr/local/src/conda/postgresql-split-18.6 -fdebug-prefix-map=/workspace/pgenv=/usr/local/src/conda-prefix' 'LDFLAGS=-Wl,-O2 -Wl,--sort-common -Wl,--as-needed -Wl,-z,relro -Wl,-z,now -Wl,--allow-shlib-undefined -Wl,-rpath,/workspace/pgenv/lib -Wl,-rpath-link,/workspace/pgenv/lib -L/workspace/pgenv/lib' 'CPPFLAGS=-DNDEBUG -D_FORTIFY_SOURCE=2 -O2 -isystem /workspace/pgenv/include -DHWCAP_CRC32=0x80 -DHWCAP_SVE=0x400000' 'CPP=aarch64-conda-linux-gnu-cpp' 'PKG_CONFIG_PATH=/workspace/pgenv/lib/pkgconfig'"
...
#define PG_VERSION_STR "PostgreSQL 18.6 on aarch64-conda-linux-gnu, compiled by aarch64-conda-linux-gnu-cc (conda-forge gcc 15.3.0-4) 15.3.0, 64-bit"
